...
int main() {
  ...
  cout << "                                             |                                     |" << endl;
  cout << " Welcome to Castlez!                         |   █                             █   |" << endl;
  cout << " Players Online: 6                           |                                     |" << endl;
  ...
  if(command == 2) {
    ...
    exit(); //the message printed on the screen
    this_thread::sleep_for (chrono::seconds(3)); //wait 3 seconds than closes the game
